...
const ADVANCED_ITEMS: SignalItem[] = [
    {
        key: 'horus_Buy',
        guideTarget: 'Horus ÔÇö Buy Entry',
        label: 'Horus Buy',
    ...
    {
        key: 'horus_Sell',
        guideTarget: 'Horus ÔÇö Sell Entry',
        label: 'Horus Sell',
        description: 'Precision Scalping. Validated entry for advanced traders.',
        icon: 'trending-down-outline',
        color: '#EF4444'
        ...
        description: (
            <View>
                ...
                <Text style={{ color: '#888', fontSize: 10, fontStyle: 'italic', lineHeight: 14 }}>
                    ...
                    ATR 10ÔÇô20: Wait for 2 M1 candles + clear rejection.{"\n"}
                    ATR &gt; 20: Wait 3ÔÇô5 M1 candles or sweep-and-reclaim.
                </Text>
            </View>
        ),
        icon: 'moon',
        ...
        description: (
            <View>
                ...
                <Text style={{ color: '#888', fontSize: 10, fontStyle: 'italic', lineHeight: 14 }}>
                    ...
                    ATR 10ÔÇô20: Need 2 M1 candles + clear rejection.{"\n"}
                    ATR &gt; 20: Wait 3ÔÇô5 M1 candles/sweep-reclaim or it may slide.
                </Text>
            </View>
        ),
        ...
        description: (
            <View>
                ...
                <Text style={{ color: '#888', fontSize: 10, fontStyle: 'italic', lineHeight: 14 }}>
                    ...
                    ATR 10ÔÇô20: Wait 2 M1 candles + rejection.{"\n"}
                    ATR &gt; 20: 3ÔÇô5 M1 candles or sweep-reclaim required.
                </Text>
            </View>
        ),
        icon: 'flash',
...
const CONTEXT_ITEMS: SignalItem[] = [
    {
        ...
        guideTarget: 'Syncro Buy (H1) ÔÇö SPX / ES / NQ',
        label: 'Syncro Buy (H1)',
    ...
    },
    {
        ...
        guideTarget: 'Syncro Sell (H1) ÔÇö SPX / ES / NQ',
                        ...
                        >
                            ...
                            <View style={{ marginBottom: 20 }}>
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 12, gap: 6 }}>
                                    ...
                                    <Text style={{ color: '#555', fontSize: 9, fontWeight: 'bold', letterSpacing: 1 }}>TAP TO ZOOM ┬À SWIPE FOR ALL</Text>
                                    <View style={{ width: 10, height: 1, backgroundColor: 'rgba(255,255,255,0.2)' }} />
                                </View>
                            </View>
